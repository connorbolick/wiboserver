...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('employee_designer')

        # Adding model 'Employee'
        db.create_table('employee_employee', (
            ('wibo_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], primary_key=True)),
            ...
            ('graduation', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
    ...
    def backwards(self, orm):
        ...
        db.create_table('employee_designer', (
            ('wibo_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], primary_key=True)),
        ))
        db.send_create_signal('employee', ['Designer'])
