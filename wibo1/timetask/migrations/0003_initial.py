...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('timetask_timelog', (
            ...
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cards.JobCard'])),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('time_in', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('time_out', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
