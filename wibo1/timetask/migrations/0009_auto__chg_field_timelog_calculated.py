...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Timelog.calculated'
        db.alter_column('timetask_timelog', 'calculated', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=10))

    def backwards(self, orm):

        # Changing field 'Timelog.calculated'
        db.alter_column('timetask_timelog', 'calculated', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
    ...
    models = {
        ...
        'timetask.timelog': {
            ...
            'calculated': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '10', 'blank': 'True'}),
