...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Timelog.calculated'
        db.add_column('timetask_timelog', 'calculated',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Timelog.time_in'
        db.alter_column('timetask_timelog', 'time_in', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Timelog.calculated'
        db.delete_column('timetask_timelog', 'calculated')


        # User chose to not deal with backwards NULL issues for 'Timelog.time_in'
        raise RuntimeError("Cannot reverse this migration. 'Timelog.time_in' and its values cannot be restored.")
    ...
    models = {
        ...
        'timetask.timelog': {
            ...
            'calculated': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
