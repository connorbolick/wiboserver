...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Timelog.employeeid'
        db.delete_column('timetask_timelog', 'employeeid_id')

        # Deleting field 'Timelog.jobid'
        db.delete_column('timetask_timelog', 'jobid_id')

        # Adding field 'Timelog.employee'
        db.add_column('timetask_timelog', 'employee',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 7, 16, 0, 0), to=orm['employee.Employee']),
                      keep_default=False)

        # Adding field 'Timelog.job'
        db.add_column('timetask_timelog', 'job',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 7, 16, 0, 0), to=orm['cards.JobCard']),
                      keep_default=False)


        # Changing field 'Timelog.time_in'
        db.alter_column('timetask_timelog', 'time_in', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 7, 16, 0, 0)))

        # Changing field 'Timelog.time_out'
        db.alter_column('timetask_timelog', 'time_out', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 7, 16, 0, 0)))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Timelog.employeeid'
        raise RuntimeError("Cannot reverse this migration. 'Timelog.employeeid' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Timelog.jobid'
        raise RuntimeError("Cannot reverse this migration. 'Timelog.jobid' and its values cannot be restored.")
        # Deleting field 'Timelog.employee'
        db.delete_column('timetask_timelog', 'employee_id')

        # Deleting field 'Timelog.job'
        db.delete_column('timetask_timelog', 'job_id')


        # Changing field 'Timelog.time_in'
        db.alter_column('timetask_timelog', 'time_in', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Timelog.time_out'
        db.alter_column('timetask_timelog', 'time_out', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        'timetask.timelog': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cards.JobCard']"}),
            'time_in': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'time_out': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
