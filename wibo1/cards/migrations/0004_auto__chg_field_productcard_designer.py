...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductCard.designer'
        db.alter_column('cards_productcard', 'designer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employee.Employee']))

    def backwards(self, orm):

        # Changing field 'ProductCard.designer'
        db.alter_column('cards_productcard', 'designer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
