...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'JobCard.billing_notes'
        db.delete_column('cards_jobcard', 'billing_notes')

        # Adding field 'JobCard.job_notes'
        db.add_column('cards_jobcard', 'job_notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'JobCard.billing_notes'
        db.add_column('cards_jobcard', 'billing_notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'JobCard.job_notes'
        db.delete_column('cards_jobcard', 'job_notes')
