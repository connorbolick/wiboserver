...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobCard.price_override'
        db.add_column('cards_jobcard', 'price_override',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobCard.price_override'
        db.delete_column('cards_jobcard', 'price_override')
