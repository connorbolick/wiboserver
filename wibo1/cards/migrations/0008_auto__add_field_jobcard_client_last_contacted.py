...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobCard.client_last_contacted'
        db.add_column('cards_jobcard', 'client_last_contacted',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobCard.client_last_contacted'
        db.delete_column('cards_jobcard', 'client_last_contacted')
