...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JobCard.invoice_date'
        db.alter_column('cards_jobcard', 'invoice_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'JobCard.invoice_date'
        db.alter_column('cards_jobcard', 'invoice_date', self.gf('django.db.models.fields.DateField')(null=True))
