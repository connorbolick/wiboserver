...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobCard.job_roi'
        db.add_column('cards_jobcard', 'job_roi',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='job', null=True, to=orm['roi.JobROI']),
                      keep_default=False)


        # Changing field 'JobCard.job_name'
        db.alter_column('cards_jobcard', 'job_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ProductCard.product_name'
        db.alter_column('cards_productcard', 'product_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'JobCard.job_roi'
        db.delete_column('cards_jobcard', 'job_roi_id')


        # Changing field 'JobCard.job_name'
        db.alter_column('cards_jobcard', 'job_name', self.gf('django.db.models.fields.CharField')(default='Job Name', max_length=255))

        # Changing field 'ProductCard.product_name'
        db.alter_column('cards_productcard', 'product_name', self.gf('django.db.models.fields.CharField')(default='Product Name', max_length=255))
