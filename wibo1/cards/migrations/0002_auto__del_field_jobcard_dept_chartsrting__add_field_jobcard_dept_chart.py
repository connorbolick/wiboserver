...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'JobCard.dept_chartsrting'
        db.delete_column('cards_jobcard', 'dept_chartsrting')

        # Adding field 'JobCard.dept_chartstring'
        db.add_column('cards_jobcard', 'dept_chartstring',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'JobCard.dept_chartsrting'
        db.add_column('cards_jobcard', 'dept_chartsrting',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'JobCard.dept_chartstring'
        db.delete_column('cards_jobcard', 'dept_chartstring')
