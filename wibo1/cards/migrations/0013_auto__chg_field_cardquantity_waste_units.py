...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CardQuantity.waste_units'
        db.alter_column('cards_cardquantity', 'waste_units', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=3))

    def backwards(self, orm):

        # Changing field 'CardQuantity.waste_units'
        db.alter_column('cards_cardquantity', 'waste_units', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=3))
