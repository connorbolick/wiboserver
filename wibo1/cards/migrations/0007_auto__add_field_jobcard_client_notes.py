...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobCard.client_notes'
        db.add_column('cards_jobcard', 'client_notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'JobCard.due_date'
        db.add_column('cards_jobcard', 'due_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobCard.client_notes'
        db.delete_column('cards_jobcard', 'client_notes')

        # Deleting field 'JobCard.due_date'
        db.delete_column('cards_jobcard', 'due_date')
