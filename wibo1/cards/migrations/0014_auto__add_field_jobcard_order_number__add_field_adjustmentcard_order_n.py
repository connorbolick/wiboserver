...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobCard.order_number'
        db.add_column('cards_jobcard', 'order_number',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AdjustmentCard.order_number'
        db.add_column('cards_adjustmentcard', 'order_number',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DesignCard.order_number'
        db.add_column('cards_designcard', 'order_number',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ServiceCard.order_number'
        db.add_column('cards_servicecard', 'order_number',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProductCard.order_number'
        db.add_column('cards_productcard', 'order_number',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobCard.order_number'
        db.delete_column('cards_jobcard', 'order_number')

        # Deleting field 'AdjustmentCard.order_number'
        db.delete_column('cards_adjustmentcard', 'order_number')

        # Deleting field 'DesignCard.order_number'
        db.delete_column('cards_designcard', 'order_number')

        # Deleting field 'ServiceCard.order_number'
        db.delete_column('cards_servicecard', 'order_number')

        # Deleting field 'ProductCard.order_number'
        db.delete_column('cards_productcard', 'order_number')
