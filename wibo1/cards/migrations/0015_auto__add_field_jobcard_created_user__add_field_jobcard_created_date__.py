...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobCard.created_user'
        db.add_column('cards_jobcard', 'created_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='cards_jobcard_created_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'JobCard.created_date'
        db.add_column('cards_jobcard', 'created_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 2, 4, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'JobCard.updated_user'
        db.add_column('cards_jobcard', 'updated_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='cards_jobcard_updated_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'JobCard.updated_date'
        db.add_column('cards_jobcard', 'updated_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2014, 2, 4, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'JobCard.admin_approved'
        db.add_column('cards_jobcard', 'admin_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'JobCard.admin_approved_user'
        db.add_column('cards_jobcard', 'admin_approved_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cards_jobcard_admin_set', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'JobCard.admin_approved_date'
        db.add_column('cards_jobcard', 'admin_approved_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AdjustmentCard.created_user'
        db.add_column('cards_adjustmentcard', 'created_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='cards_adjustmentcard_created_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AdjustmentCard.created_date'
        db.add_column('cards_adjustmentcard', 'created_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 2, 4, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'AdjustmentCard.updated_user'
        db.add_column('cards_adjustmentcard', 'updated_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='cards_adjustmentcard_updated_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AdjustmentCard.updated_date'
        db.add_column('cards_adjustmentcard', 'updated_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2014, 2, 4, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'AdjustmentCard.admin_approved'
        db.add_column('cards_adjustmentcard', 'admin_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AdjustmentCard.admin_approved_user'
        db.add_column('cards_adjustmentcard', 'admin_approved_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cards_adjustmentcard_admin_set', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AdjustmentCard.admin_approved_date'
        db.add_column('cards_adjustmentcard', 'admin_approved_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DesignCard.created_user'
        db.add_column('cards_designcard', 'created_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='cards_designcard_created_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'DesignCard.created_date'
        db.add_column('cards_designcard', 'created_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 2, 4, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'DesignCard.updated_user'
        db.add_column('cards_designcard', 'updated_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='cards_designcard_updated_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'DesignCard.updated_date'
        db.add_column('cards_designcard', 'updated_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2014, 2, 4, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'DesignCard.admin_approved'
        db.add_column('cards_designcard', 'admin_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DesignCard.admin_approved_user'
        db.add_column('cards_designcard', 'admin_approved_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cards_designcard_admin_set', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'DesignCard.admin_approved_date'
        db.add_column('cards_designcard', 'admin_approved_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ServiceCard.created_user'
        db.add_column('cards_servicecard', 'created_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='cards_servicecard_created_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ServiceCard.created_date'
        db.add_column('cards_servicecard', 'created_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 2, 4, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ServiceCard.updated_user'
        db.add_column('cards_servicecard', 'updated_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='cards_servicecard_updated_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ServiceCard.updated_date'
        db.add_column('cards_servicecard', 'updated_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2014, 2, 4, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ServiceCard.admin_approved'
        db.add_column('cards_servicecard', 'admin_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ServiceCard.admin_approved_user'
        db.add_column('cards_servicecard', 'admin_approved_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cards_servicecard_admin_set', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ServiceCard.admin_approved_date'
        db.add_column('cards_servicecard', 'admin_approved_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProductCard.created_user'
        db.add_column('cards_productcard', 'created_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='cards_productcard_created_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ProductCard.created_date'
        db.add_column('cards_productcard', 'created_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 2, 4, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ProductCard.updated_user'
        db.add_column('cards_productcard', 'updated_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='cards_productcard_updated_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ProductCard.updated_date'
        db.add_column('cards_productcard', 'updated_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2014, 2, 4, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ProductCard.admin_approved'
        db.add_column('cards_productcard', 'admin_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProductCard.admin_approved_user'
        db.add_column('cards_productcard', 'admin_approved_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cards_productcard_admin_set', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ProductCard.admin_approved_date'
        db.add_column('cards_productcard', 'admin_approved_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobCard.created_user'
        db.delete_column('cards_jobcard', 'created_user_id')

        # Deleting field 'JobCard.created_date'
        db.delete_column('cards_jobcard', 'created_date')

        # Deleting field 'JobCard.updated_user'
        db.delete_column('cards_jobcard', 'updated_user_id')

        # Deleting field 'JobCard.updated_date'
        db.delete_column('cards_jobcard', 'updated_date')

        # Deleting field 'JobCard.admin_approved'
        db.delete_column('cards_jobcard', 'admin_approved')

        # Deleting field 'JobCard.admin_approved_user'
        db.delete_column('cards_jobcard', 'admin_approved_user_id')

        # Deleting field 'JobCard.admin_approved_date'
        db.delete_column('cards_jobcard', 'admin_approved_date')

        # Deleting field 'AdjustmentCard.created_user'
        db.delete_column('cards_adjustmentcard', 'created_user_id')

        # Deleting field 'AdjustmentCard.created_date'
        db.delete_column('cards_adjustmentcard', 'created_date')

        # Deleting field 'AdjustmentCard.updated_user'
        db.delete_column('cards_adjustmentcard', 'updated_user_id')

        # Deleting field 'AdjustmentCard.updated_date'
        db.delete_column('cards_adjustmentcard', 'updated_date')

        # Deleting field 'AdjustmentCard.admin_approved'
        db.delete_column('cards_adjustmentcard', 'admin_approved')

        # Deleting field 'AdjustmentCard.admin_approved_user'
        db.delete_column('cards_adjustmentcard', 'admin_approved_user_id')

        # Deleting field 'AdjustmentCard.admin_approved_date'
        db.delete_column('cards_adjustmentcard', 'admin_approved_date')

        # Deleting field 'DesignCard.created_user'
        db.delete_column('cards_designcard', 'created_user_id')

        # Deleting field 'DesignCard.created_date'
        db.delete_column('cards_designcard', 'created_date')

        # Deleting field 'DesignCard.updated_user'
        db.delete_column('cards_designcard', 'updated_user_id')

        # Deleting field 'DesignCard.updated_date'
        db.delete_column('cards_designcard', 'updated_date')

        # Deleting field 'DesignCard.admin_approved'
        db.delete_column('cards_designcard', 'admin_approved')

        # Deleting field 'DesignCard.admin_approved_user'
        db.delete_column('cards_designcard', 'admin_approved_user_id')

        # Deleting field 'DesignCard.admin_approved_date'
        db.delete_column('cards_designcard', 'admin_approved_date')

        # Deleting field 'ServiceCard.created_user'
        db.delete_column('cards_servicecard', 'created_user_id')

        # Deleting field 'ServiceCard.created_date'
        db.delete_column('cards_servicecard', 'created_date')

        # Deleting field 'ServiceCard.updated_user'
        db.delete_column('cards_servicecard', 'updated_user_id')

        # Deleting field 'ServiceCard.updated_date'
        db.delete_column('cards_servicecard', 'updated_date')

        # Deleting field 'ServiceCard.admin_approved'
        db.delete_column('cards_servicecard', 'admin_approved')

        # Deleting field 'ServiceCard.admin_approved_user'
        db.delete_column('cards_servicecard', 'admin_approved_user_id')

        # Deleting field 'ServiceCard.admin_approved_date'
        db.delete_column('cards_servicecard', 'admin_approved_date')

        # Deleting field 'ProductCard.created_user'
        db.delete_column('cards_productcard', 'created_user_id')

        # Deleting field 'ProductCard.created_date'
        db.delete_column('cards_productcard', 'created_date')

        # Deleting field 'ProductCard.updated_user'
        db.delete_column('cards_productcard', 'updated_user_id')

        # Deleting field 'ProductCard.updated_date'
        db.delete_column('cards_productcard', 'updated_date')

        # Deleting field 'ProductCard.admin_approved'
        db.delete_column('cards_productcard', 'admin_approved')

        # Deleting field 'ProductCard.admin_approved_user'
        db.delete_column('cards_productcard', 'admin_approved_user_id')

        # Deleting field 'ProductCard.admin_approved_date'
        db.delete_column('cards_productcard', 'admin_approved_date')
    ...
    models = {
        ...
        'cards.adjustmentcard': {
            ...
            'admin_approved_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
