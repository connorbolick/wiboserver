...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobCard.invoice_date'
        db.add_column('cards_jobcard', 'invoice_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobCard.invoice_date'
        db.delete_column('cards_jobcard', 'invoice_date')
