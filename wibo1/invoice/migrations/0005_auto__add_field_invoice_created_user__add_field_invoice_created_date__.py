...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.created_user'
        db.add_column('invoice_invoice', 'created_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='invoice_invoice_created_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Invoice.created_date'
        db.add_column('invoice_invoice', 'created_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 5, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Invoice.updated_user'
        db.add_column('invoice_invoice', 'updated_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='invoice_invoice_updated_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Invoice.updated_date'
        db.add_column('invoice_invoice', 'updated_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 3, 5, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'PaymentEventWebInvoice.web_invoice_number'
        db.alter_column('invoice_paymenteventwebinvoice', 'web_invoice_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'PaymentEvent.payment_date'
        db.alter_column('invoice_paymentevent', 'payment_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'Invoice.created_user'
        db.delete_column('invoice_invoice', 'created_user_id')

        # Deleting field 'Invoice.created_date'
        db.delete_column('invoice_invoice', 'created_date')

        # Deleting field 'Invoice.updated_user'
        db.delete_column('invoice_invoice', 'updated_user_id')

        # Deleting field 'Invoice.updated_date'
        db.delete_column('invoice_invoice', 'updated_date')


        # Changing field 'PaymentEventWebInvoice.web_invoice_number'
        db.alter_column('invoice_paymenteventwebinvoice', 'web_invoice_number', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # Changing field 'PaymentEvent.payment_date'
        db.alter_column('invoice_paymentevent', 'payment_date', self.gf('django.db.models.fields.DateField')(auto_now=True))
