...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PaymentEventGiftCard'
        db.create_table('invoice_paymenteventgiftcard', (
            ...
            ('payment_type', self.gf('django.db.models.fields.CharField')(default='GIFT', max_length=5)),
            ('gift_card_number', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('invoice', ['PaymentEventGiftCard'])


    def backwards(self, orm):
        # Deleting model 'PaymentEventGiftCard'
        db.delete_table('invoice_paymenteventgiftcard')
