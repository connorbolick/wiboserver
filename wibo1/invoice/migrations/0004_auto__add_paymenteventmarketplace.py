...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PaymentEventMarketplace'
        db.create_table('invoice_paymenteventmarketplace', (
            ...
            ('payment_type', self.gf('django.db.models.fields.CharField')(default='MARKET', max_length=10)),
            ('order_number', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('invoice', ['PaymentEventMarketplace'])


    def backwards(self, orm):
        # Deleting model 'PaymentEventMarketplace'
        db.delete_table('invoice_paymenteventmarketplace')
