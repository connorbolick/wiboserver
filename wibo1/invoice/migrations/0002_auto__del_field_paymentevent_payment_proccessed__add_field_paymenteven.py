...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PaymentEvent.payment_proccessed'
        db.delete_column('invoice_paymentevent', 'payment_proccessed')

        # Adding field 'PaymentEvent.payment_processed'
        db.add_column('invoice_paymentevent', 'payment_processed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PaymentEvent.payment_proccessed'
        db.add_column('invoice_paymentevent', 'payment_proccessed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'PaymentEvent.payment_processed'
        db.delete_column('invoice_paymentevent', 'payment_processed')
