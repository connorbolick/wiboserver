...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.roi'
        db.add_column('contacts_contact', 'roi',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['roi.ClientROI']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.roi'
        db.delete_column('contacts_contact', 'roi_id')
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'roi': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['roi.ClientROI']"}),
